...
cursor.execute('INSERT INTO alunos(id, nome, idade, curso) VALUES (1,"Marcelo", 8, "matemática")')
cursor.execute('INSERT INTO alunos(id, nome, idade, curso) VALUES (2,"Caetano", 12, "engenharia")')
cursor.execute('INSERT INTO alunos(id, nome, idade, curso) VALUES (3,"Isis", 18, "engenharia")')
cursor.execute('INSERT INTO alunos(id, nome, idade, curso) VALUES (4,"Maira", 21, "matemática")')
cursor.execute('INSERT INTO alunos(id, nome, idade, curso) VALUES (5,"Jorge", 31, "engenharia")')
...
#cursor.execute('UPDATE alunos SET idade  = 3 WHERE nome="Isis"')
...
#cursor.execute('INSERT INTO clientes(id, nome, idade, saldo) VALUES (1,"Marcelo", 8, 5000)')
#cursor.execute('INSERT INTO clientes(id, nome, idade, saldo) VALUES (2,"Caetano", 12, 100.25)')
#cursor.execute('INSERT INTO clientes(id, nome, idade, saldo) VALUES (3,"Isis", 18, 100000.5)')
#cursor.execute('INSERT INTO clientes(id, nome, idade, saldo) VALUES (4,"Maira", 21, 20000)')
#cursor.execute('INSERT INTO clientes(id, nome, idade, saldo) VALUES (5,"Jorge", 31, 50000.25)')
...
#cursor.execute('INSERT INTO compras(id, cliente_id, produto, valor) VALUES (1,2,"Blusa",2000)')
#cursor.execute('INSERT INTO compras(id, cliente_id, produto, valor) VALUES (2,2,"Saia",2500)')
#cursor.execute('INSERT INTO compras(id, cliente_id, produto, valor) VALUES (3,3,"Casaco",5000)')
